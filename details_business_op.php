...
require 'data-fields-business_op.php';
...
$sql_listing = "SELECT * FROM $db_tbl_businessop WHERE $db_mls_id = :mls_id";
...
photoCheck($abs_photos,$mls_id);
for ($a = 0; $a <= $data_listing[$db_PhotoCount]; $a++) {
   if (photo_exists($abs_photos,$mls_id,$a)) {
      $photo_src = photo_exists($abs_photos,$mls_id,$a);
      $photo_count++;
      if ($photo_count == 1) {
...
$output .= "     <tr><td><b>Apx. BuildingS q Ft:</b> </td><td>".$data_listing[$db_APXBuildingSqFt]."</td>\n";
$output .= "     <td><b>Total Living SF:</b> </td><td>".$data_listing[$db_TotalLivingSF]."</td></tr>\n";
...
$output .= "     <td><b>Natural Gas Present:</b> </td><td>".$data_listing[$db_NaturalGasYN]."</td></tr>\n";
...
$output .= "     <tr><td><b>Directions:</b> </td><td>".$data_listing[$db_Directions]."</td></tr>\n";
$output .= "     <tr><td><b>Sale Includes:</b> </td><td>".$data_listing[$db_SaleIncludes]."</td></tr>\n";
$output .= "   </table><br />\n";
...
$output .= "     <tr><td><b>Elevator:</b> </td><td>".$data_listing[$db_ElevatorYN]."</td>\n";
$output .= "     <td><b>Floor:</b> </td><td>".$data_listing[$db_Floor]."</td></tr>\n";
$output .= "     <tr><td><b>Extras:</b> </td><td>".$data_listing[$db_Extras]."</td>\n";
$output .= "     <td><b>Exterior Miscellaneous:</b> </td><td>".$data_listing[$db_ExteriorMiscellaneous]."</td></tr>\n";
$output .= "     <tr><td><b>Date New Listing:</b> </td><td>".$data_listing[$db_DateNewListing]."</td>\n";
$output .= "     <td><b>Deed Restrictions:</b> </td><td>".$data_listing[$db_DeedRestrictions]."</td></tr>\n";
...
$output .= "     <tr><td><b>Dockage:</b> </td><td>".$data_listing[$db_Dockage]."</td>\n";
$output .= "     <td valign='top'><b>Dual Commisson:</b> </td><td colspan='3' valign='top'>".$data_listing[$db_DualCommisson]."</td></tr>\n";
$output .= "     <tr><td><b>Electric Voltage:</b> </td><td>".$data_listing[$db_ElectricVoltage]."</td>\n";
$output .= "     <td><b>Existing Mtg:</b> </td><td>".$data_listing[$db_ExistingMtg]."</td></tr>\n";
$output .= "     <tr><td><b>Foreclosed:</b> </td><td>".$data_listing[$db_ForeclosedYN]."</td>\n";
$output .= "     <td><b>Gross Income:</b> </td><td>".$data_listing[$db_GrossIncome]."</td></tr>\n";
...
$output .= "     <tr><td><b>Offerings:</b> </td><td>".$data_listing[$db_Offerings]."</td>\n";
$output .= "     <td><b>Operating Expenses:</b> </td><td>".$data_listing[$db_OperatingExpenses]."</td></tr>\n";
...
$output .= "     <td><b>VOW:</b> </td><td>".$data_listing[$db_VOWYN]."</td></tr>\n";
...
$output .= "     <tr><td><b>Parking:</b> </td><td>".$data_listing[$db_Parking]."</td>\n";
$output .= "     <td><b>Property Type Features:</b> </td><td>".$data_listing[$db_PropertyTypeFeatures]."</td></tr>\n";
$output .= "     <tr><td><b>Restrooms:</b> </td><td>".$data_listing[$db_Restrooms]."</td>\n";
$output .= "     <td><b>For Sale:</b> </td><td>".$data_listing[$db_SaleYN]."</td></tr>\n";
$output .= "     <tr><td><b>Sprinkler System:</b> </td><td>".$data_listing[$db_SprinklerYN]."</td>\n";
$output .= "     <td><b>Units:</b> </td><td>".$data_listing[$db_Units]."</td></tr>\n";
$output .= "     <td colspan='2'></td></tr>\n";
$output .= "   </table><br />\n";
...
$output .= "     <td><b>Lease Term:</b> </td><td>".$data_listing[$db_LeaseTerm]."</td></tr>\n";
...
$output .= "     <td><b>HOA</b> </td><td>".$data_listing[$db_HOAYN]."</td></tr>\n";
$output .= "     <tr><td><b>AVM:</b> </td><td>".$data_listing[$db_AVMYN]."</td>\n";
$output .= "     <td><b>Annual Lease Amt:</b> </td><td>".$data_listing[$db_AnnualLeaseAmt]."</td></tr>\n";

...
require 'data-fields-commercial.php';
...
$sql_listing = "SELECT * FROM $db_tbl_commercial WHERE $db_mls_id = :mls_id";
...
photoCheck($abs_photos,$mls_id);
for ($a = 0; $a <= $data_listing[$db_photo_count]; $a++) {
   if (photo_exists($abs_photos,$mls_id,$a)) {
      $photo_src = photo_exists($abs_photos,$mls_id,$a);
      $photo_count++;
      if ($photo_count == 1) {
...
$output .= "     <td><b>Apx. Building Sq Ft:</b> </td><td>".$data_listing[$db_APXBuildingSqFt]."</td></tr>\n";
$output .= "     <tr><td><b>Baths:</b> </td><td>".$data_listing[$db_Baths]."</td>\n";
$output .= "     <td><b>Office Sq Ft:</b> </td><td>".$data_listing[$db_OfficeSqFt]."</td></tr>\n";
$output .= "     <tr><td><b>Sprinkler System:</b> </td><td>".$data_listing[$db_SprinklerYN]."</td>\n";
$output .= "     <td><b>Apx. Liv. SqFt:</b> </td><td>".$data_listing[$db_TotalLivingSF]."</td></tr>\n";
...
$output .= "     <td><b>Parking:</b> </td><td>".$data_listing[$db_Parking]."</td></tr>\n";
...
$output .= "     <tr><td><b>Exterior Miscellaneous:</b> </td><td>".$data_listing[$db_ExteriorMiscellaneous]."</td></tr>\n";
$output .= "     <tr><td><b>Extras:</b> </td><td>".$data_listing[$db_Extras]."</td></tr>\n";
$output .= "   </table><br />\n";
...
$output .= "   <table width='100%' border='0' cellpadding='1' cellspacing='0' style='font-family: Arial,Helvetica,sans-serif;font-size: 12px;color: #000;'>\n";
$output .= "     <tr><td><b>Additional Exp:</b> </td><td>".$data_listing[$db_AdditionalExp]."</td>\n";
$output .= "     <td><b>Apx Warehouse Sq Ft:</b> </td><td>".$data_listing[$db_ApxWarehouseSqFt]."</td></tr>\n";
$output .= "     <tr><td><b>Ceiling Height:</b> </td><td>".$data_listing[$db_CeilingHeight]."</td>\n";
...
$output .= "     <td><b>Sale:</b> </td><td>".$data_listing[$db_SaleYN]."</td></tr>\n";
$output .= "     <tr><td><b>Cooling:</b> </td><td>".$data_listing[$db_Cooling]."</td>\n";
$output .= "     <td><b>Heating:</b> </td><td>".$data_listing[$db_Heating]."</td></tr>\n";
$output .= "     <tr><td><b>Floor:</b> </td><td>".$data_listing[$db_Floor]."</td>\n";
$output .= "     <td><b>Frontage Road:</b> </td><td>".$data_listing[$db_FrontageRoad]."</td></tr>\n";
$output .= "     <tr><td><b>Deed Restrictions:</b> </td><td>".$data_listing[$db_DeedRestrictions]."</td>\n";
$output .= "     <td><b>Dockage:</b> </td><td>".$data_listing[$db_Dockage]."</td></tr>\n";
$output .= "     <tr><td><b>Electric Voltage:</b> </td><td>".$data_listing[$db_ElectricVoltage]."</td>\n";
$output .= "     <td><b>Elevator:</b> </td><td>".$data_listing[$db_ElevatorYN]."</td></tr>\n";
$output .= "     <tr><td><b>Existing Management:</b> </td><td>".$data_listing[$db_ExistingMtg]."</td>\n";
$output .= "     <td><b>Natural Gas:</b> </td><td>".$data_listing[$db_NaturalGasYN]."</td></tr>\n";
$output .= "     <tr><td><b>Overhead Doors:</b> </td><td>".$data_listing[$db_OverheadDoors]."</td>\n";
...
$output .= "     <td><b>Property Sub type:</b> </td><td>".$data_listing[$db_PropertySubtype]."</td></tr>\n";
$output .= "     <tr><td><b>Property Type:</b> </td><td>".$data_listing[$db_PropertyType]."</td>\n";
$output .= "     <td><b>Property Type Features:</b> </td><td>".$data_listing[$db_PropertyTypeFeatures]."</td></tr>\n";
$output .= "     <tr><td><b>Property Format:</b> </td><td>".$data_listing[$db_PropertyFormat]."</td>\n";
...
$output .= "     <td><b>Restrooms:</b> </td><td>".$data_listing[$db_Restrooms]."</td></tr>\n";
$output .= "     <tr><td><b>Sewer:</b> </td><td>".$data_listing[$db_Sewer]."</td>\n";
$output .= "     <td><b>Stories:</b> </td><td>".$data_listing[$db_Stories]."</td></tr>\n";
$output .= "     <tr><td><b>Units:</b> </td><td>".$data_listing[$db_Units]."</td>\n";
$output .= "     <td><b>Total Units:</b> </td><td>".$data_listing[$db_TotalUnits]."</td></tr>\n";
$output .= "     <tr><td><b>Tax Amount:</b> </td><td>".$data_listing[$db_TaxAmount]."</td>\n";
$output .= "     <td><b>Sale Includes:</b> </td><td>".$data_listing[$db_SaleIncludes]."</td></tr>\n";
$output .= "     <tr><td><b>Utilities:</b> </td><td>".$data_listing[$db_Utilities]."</td>\n";
$output .= "     <tr><td><b>Water:</b> </td><td>".$data_listing[$db_Water]."</td></tr>\n";
$output .= "     <tr><td><b>Sale Includes:</b> </td><td>".$data_listing[$db_SaleIncludes]."</td>\n";
$output .= "     <td><b>Directions:</b> </td><td>".$data_listing[$db_Directions]."</td></tr>\n";
$output .= "     <td colspan='2'></td></tr>\n";
$output .= "   </table><br />\n";
$output .= "   <table width='100%' border='0' cellpadding='1' cellspacing='0' style='font-family: Arial,Helvetica,sans-serif;font-size: 12px;color: #000;'>\n";
...
$output .= "     <tr><td><b>Lease:</b> </td><td>".$data_listing[$db_LeaseYN]."</td>\n";
$output .= "     <td><b>Lease Option:</b> </td><td>".$data_listing[$db_LeaseOption]."</td></tr>\n";
$output .= "     <tr><td><b>Lease Rate:</b> </td><td>".$data_listing[$db_LeaseRate]."</td>\n";
$output .= "     <td><b>Lease Term</b> </td><td>".$data_listing[$db_LeaseTerm]."</td></td>\n";
$output .= "     <tr><td><b>Lease Terms:</b> </td><td>".$data_listing[$db_LeaseTerms]."</td>\n";
$output .= "     <td><b>Lease Type</b> </td><td>".$data_listing[$db_LeaseType]."</td></tr>\n";
$output .= "     <tr><td><b>Annual Lease Amount:</b> </td><td>".$data_listing[$db_AnnualLeaseAmt]."</td>\n";
$output .= "     <td><b>Association Fee:</b> </td><td>".$data_listing[$db_AssociationFee]."</td></tr>\n";
$output .= "     <tr><td><b>Gross Income:</b> </td><td>".$data_listing[$db_GrossIncome]."</td>\n";
$output .= "     <td><b>Net Income:</b> </td><td>".$data_listing[$db_NetIncome]."</td></tr>\n";
...
$output .= "     <td><b>Agent Exempt:</b> </td><td>".$data_listing[$db_AgExemptYN]."</td></tr>\n";
$output .= "     <tr><td><b>VOW:</b> </td><td>".$data_listing[$db_VOWYN]."</td>\n";
$output .= "     <td><b>Offerings:</b> </td><td>".$data_listing[$db_Offerings]."</td></tr>\n";

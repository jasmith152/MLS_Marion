...
require 'data-fields-rental.php';
...
$output .= "     <tr><td width='15%'><b>City:</b> </td><td width='40%'>".$data_listing[$db_City]."</td>\n";
...
$output .= "     <td><b>Baths Partial:</b> </td><td>".$data_listing[$db_BathsPartial]."</td></tr>\n";
$output .= "     <tr><td><b>Baths:</b> </td><td>".$data_listing[$db_Baths]."</td>\n";
$output .= "     <td><b>Owner:</b> </td><td>".$data_listing[$db_Owner]."</td></tr>\n";
$output .= "     <tr><td><b>Owner Phone:</b> </td><td>".$data_listing[$db_OwnerPhone]."</td>\n";
$output .= "     <td><b>Total Living SF:</b> </td><td>".$data_listing[$db_TotalLivingSF]."</td></tr>\n";
$output .= "     <tr><td><b>Model Name:</b> </td><td>".$data_listing[$db_ModelName]."</td>\n";
...
$output .= "     <tr><td><b>Address:</b> </td><td>".$data_listing[$db_StreetNumber]." ".$data_listing[$db_StreetDirPrefix]." ".$data_listing[$db_StreetName]." ".$data_listing[$City]." ".$data_listing[$db_StateOrProvince]." ".$data_listing[$db_PostalCode]."</td></tr>\n";
$output .= "   </table><br />\n";
...
$output .= "   <table width='100%' border='0' cellpadding='1' cellspacing='0' style='font-family: Arial,Helvetica,sans-serif;font-size: 12px;color: #000;'>\n";
$output .= "     <tr><td><b>Withdrawn Status:</b> </td><td>".$data_listing[$db_WithdrawnStatus]."</td>\n";
...
$output .= "     <td><b>Original Price:</b> </td><td>".$data_listing[$db_OriginalPrice]."</td></tr>\n";
$output .= "     <tr><td><b>Days On Market:</b> </td><td>".$data_listing[$db_DaysOnMarket]."</td>\n";
$output .= "     <td><b>Occupied:</b> </td><td>".$data_listing[$db_OccupiedYN]."</td></tr>\n";
...
$output .= "     <tr><td><b>Baths Partial:</b> </td><td>".$data_listing[$db_BathsPartial]."</td>\n";
$output .= "     <td><b>Date New Listing:</b> </td><td>".$data_listing[$db_DateNewListing]."</td></tr>\n";
$output .= "     <tr><td><b>Deed Restrictions:</b> </td><td>".$data_listing[$db_DeedRestrictions]."</td>\n";
$output .= "     <td><b>Lot Size Dimension 1:</b> </td><td>".$data_listing[$db_LotSizeDim1]."</td></tr>\n";
$output .= "     <tr><td><b>Lot Size Dimension 2:</b> </td><td>".$data_listing[$db_LotSizeDim2]."</td>\n";
$output .= "     <td><b>Lot Size Dimension 4:</b> </td><td>".$data_listing[$db_LotSizeDim4]."</td></tr>\n";
$output .= "     <tr><td><b>Property Format:</b> </td><td>".$data_listing[$db_PropertyFormat]."</td></tr>\n";
...
$output .= "     <td><b>Broker Commission:</b> </td><td>".$data_listing[$db_TransBrokerCommssion]."".$data_listing[$db_TransBrokerCommType]."</td></tr>\n";
$output .= "     <tr><td><b>HOA</b> </td><td>".$data_listing[$db_HOAYN]."</td>\n";
$output .= "     <td><b>AVM:</b> </td><td>".$data_listing[$db_AVMYN]."</td></tr>\n";
$output .= "     <tr><td colspan='4'>&nbsp;</td></tr>\n";
$output .= "   </table><br />\n";
$output .= "   <table width='100%' border='0' cellpadding='1' cellspacing='0' style='font-family: Arial,Helvetica,sans-serif;font-size: 12px;color: #000;'>\n";

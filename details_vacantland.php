...
require 'data-fields-vacantland.php';
...
$sql_listing = "SELECT * FROM $db_tbl_vacantland WHERE $db_mls_id = :mls_id";
...
$output .= "     <tr><td><b>Barns:</b> </td><td>".$data_listing[$db_Barns]."</td>\n";
$output .= "     <td><b>Total Living SF.:</b> </td><td>".$data_listing[$db_TotalLivingSF]."</td></tr>\n";
$output .= "     <tr><td><b>Association Fee:</b> </td><td>".$data_listing[$db_AssociationFee]."</td>\n";
$output .= "     <td><b>Easements:</b> </td><td>".$data_listing[$db_Easements]."</td></tr>\n";
...
$output .= "     <tr><td><b>Equipment Owned:</b> </td><td>".$data_listing[$db_EquipmentOwned]."</td></tr>\n";
$output .= "     <tr><td><b>Existing Management:</b> </td><td>".$data_listing[$db_ExistingMtg]."</td></tr>\n";
$output .= "     <tr><td><b>Extras:</b> </td><td>".$data_listing[$db_Extras]."</td></tr>\n";
$output .= "     <tr><td><b>Fences:</b> </td><td>".$data_listing[$db_Fences]."</td></tr>\n";
$output .= "     <tr><td><b>Showing Instructions:</b> </td><td>".$data_listing[$db_ShowingInstructions]."</td></tr>\n";
$output .= "     <tr><td><b>Offerings:</b> </td><td>".$data_listing[$db_Offerings]."</td></tr>\n";
$output .= "     <tr><td><b>Documents Available:</b> </td><td>".$data_listing[$db_DocumentsAvailable]."</td></tr>\n";
$output .= "   </table><br />\n";
...
$output .= "     <td><b>Restrictions:</b> </td><td>".$data_listing[$db_Restrictions]."</td></tr>\n";

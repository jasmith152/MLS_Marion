...
$sql1 = "SELECT * FROM tbl_idx_vacant_land WHERE LM_MST_MLS_NO = '".$mls_id."'";
...
echo "     <td width='20%'><b>Rear Expo:</b> </td><td width='45%'>".$row1['LM_MST_DRFCES']."</td></tr>\n";
...
echo "     <tr><td><b>Road Front:</b> </td><td>".$row1['LM_FML_RDFTG']."</td>\n";
echo "     <td colspan='2'>&nbsp;</td></tr>\n";
echo "     <tr><td><b>Apx. Lot Size:</b> </td><td>".$row1['LM_MST_DLOT']."</td>\n";
echo "     <td colspan='2'>&nbsp;</td></tr>\n";
echo "     <tr><td valign='top'><b>Public Rems:</b> </td><td colspan='3' valign='top'>".$row1['LM_FML_REMARK']."</td></tr>\n";
...
echo "     <tr><td><b>On Site Utilities:</b> </td><td>".$row1['LM_MST_CFF_ON_SITE_UTILITIES']."</td></tr>\n";
echo "     <tr><td><b>Avail Utilities:</b> </td><td>".$row1['LM_MST_CFF_AVAILABLE_UTILITIES']."</td></tr>\n";
echo "     <tr><td><b>Special Info:</b> </td><td>".$row1['LM_MST_CFF_SPECIAL_INFO']."</td></tr>\n";
echo "   </table><br />\n";
echo "   <table width='100%' border='0' cellpadding='1' cellspacing='0' style='font-family: Arial,Helvetica,sans-serif;font-size: 12px;color: #000;'>\n";
echo "     <tr><td><b>Lot Desc:</b> </td><td>".$row1['LM_MST_CFF_LOT_DESCRIPTION']."</td>\n";
echo "     <td><b>Land Use:</b> </td><td>".$row1['LM_MST_CFF_LAND_USE_DESC']."</td></tr>\n";
echo "     <tr><td><b>Buildings:</b> </td><td>".$row1['LM_MST_CFF_BUILDINGS']."</td>\n";
...
echo "     <td><b>Fencing:</b> </td><td>".$row1['LM_MST_CFF_FENCING']."</td></tr>\n";
...
echo "     <tr><td><b>Condo Fees:</b> </td><td colspan='3'>".$row1['LM_MST_CFF_CONDO_FEE_INCLUDES']."</td></tr>\n";
echo "   </table><br />\n";
echo "   <table width='100%' border='0' cellpadding='1' cellspacing='0' style='font-family: Arial,Helvetica,sans-serif;font-size: 12px;color: #000;'>\n";
echo "     <tr><td><b>Taxes:</b> </td><td>".$row1['LM_MST_TAX_AMT']."</td>\n";
